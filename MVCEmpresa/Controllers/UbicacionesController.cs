...
namespace MVCEmpresa.Controllers
{
    public class UbicacionesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdUbicacion,Nombre")] Ubicacion ubicacion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdUbicacion,Nombre")] Ubicacion ubicacion)
        {
