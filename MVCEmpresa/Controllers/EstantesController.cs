...
namespace MVCEmpresa.Controllers
{
    public class EstantesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdEstante,Estante1")] Estante estante)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdEstante,Estante1")] Estante estante)
        {
